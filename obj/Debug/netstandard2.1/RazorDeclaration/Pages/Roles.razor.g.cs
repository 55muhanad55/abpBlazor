...
#nullable disable
        (__builder2) => {
            __builder2.AddMarkupContent(0, "<CreateRole ds=\"ds\" OnCreated=\"async () => await refreshResult(searchKeyword.keyword,(currentPage-1)*10)\"></CreateRole> ");
        }
#nullable restore
...
#nullable disable
        (__builder2) => {
            __builder2.AddMarkupContent(1, "<EditRole ds=\"ds\" OnCreated=\"async () => await refreshResult(searchKeyword.keyword,(currentPage-1)*10)\" roleId=\"id\"></EditRole>     ");
        }
#nullable restore
